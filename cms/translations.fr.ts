...
export const FR_VOICED: Record<string, { warm: string; brief: string; terse: string }> = {
  ...
  about: {
    warm: "Je m'appelle Kévin — développeur web et mobile fullstack, freelance, à Paris. Je dirige Nareli.\n\nNeuf ans plus tard — une coopérative, un industriel agroalimentaire, un SaaS, une société suisse de capteurs, et aujourd'hui les équipes qui font appel à Nareli — le métier n'a pas changé : être la personne qui porte l'architecture, l'interface, le déploiement et l'appel quand ça casse. Dernièrement : la refonte de la boutique Shopify de Muscintime pour sa nouvelle marque, et des outils à moi — Gantt MCP, qui planifie un projet à partir d'une conversation, et Localhost Aliases, qui donne un nom à chaque serveur de dev.\n\nJe travaille avec l'IA comme avec un bon junior : elle écrit beaucoup, je relis tout, et je reste responsable de ce qui part en production.",
    brief: "Kévin — fullstack web et mobile, freelance, Paris. Je dirige Nareli. Neuf ans à être la personne qui porte l'ensemble, de l'architecture à l'appel de support ; dernièrement la refonte Shopify de Muscintime, Gantt MCP et Localhost Aliases. Assisté par l'IA, relu par moi.",
    terse: "Kévin Riou. Fullstack web & mobile, freelance, Paris. Nareli. Neuf ans, toute la stack. Livre avec l'IA, relit tout.",
  },
  help: {
