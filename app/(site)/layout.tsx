...
/**
 * The site's root layout. It lives in a route group so that Payload's admin,
 * in its own group with its own root layout, never inherits this stylesheet:
 * a top-level app/layout.tsx would wrap every route, admin included, and the
 * terminal's input reset and Tailwind's preflight would strip the admin's
 * borders.
 */
