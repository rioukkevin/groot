...
export const Window: FC<WindowProps> = ({
  ...
  return (
    <motion.div
      ...
      initial={{ opacity: 0, filter: "blur(10px)", scaleY: 0 }}
      animate={{
        opacity: 1,
      ...
      exit={{ opacity: 0, filter: "blur(10px)", scaleY: 0 }}
    ...
    >
      ...
      >
        ...
        <div
          className={cn(
            "pointer-events-auto overflow-y-auto overflow-x-hidden p-4",
            isFullscreen && "h-[calc(100%-40px)] overflow-auto",
          )}
        >
          {children}
        </div>
